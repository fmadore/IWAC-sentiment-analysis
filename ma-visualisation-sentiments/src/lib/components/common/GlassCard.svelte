...
<style>
  ...
  /* Padding variants */
  .glass-card[data-padding="none"] { padding: 0; }
  .glass-card[data-padding="sm"] { padding: 0.75rem; }
  .glass-card[data-padding="md"] { padding: 1rem; }
  .glass-card[data-padding="lg"] { padding: 1.5rem; }
  ...
  .glass-card[data-variant="large"][data-padding="md"] { padding: 1.5rem; }
  .glass-card[data-variant="large"][data-padding="lg"] { padding: 2rem; }
  ...
  @media (max-width: 768px) {
    .glass-card[data-padding="md"] { padding: 0.875rem; }
    .glass-card[data-padding="lg"] { padding: 1.25rem; }
    .glass-card[data-variant="large"][data-padding="md"] { padding: 1.25rem; }
    .glass-card[data-variant="large"][data-padding="lg"] { padding: 1.5rem; }
  }

  @media (max-width: 480px) {
    .glass-card[data-padding="md"] { padding: 0.75rem; }
    .glass-card[data-padding="lg"] { padding: 1rem; }
  }
