...
selectedDataset.subscribe(value => { _selectedDataset = value; });
comparisonMode.subscribe(value => { _comparisonMode = value; });
comparisonPair.subscribe(value => { _comparisonPair = value; });
