...
export const en: Translations = {
  ...
  comparison: {
    ...
    significantDifferencesExplanation: 'Articles where any dimension (polarity, subjectivity, or centrality) differs by 3+ points between ChatGPT and Gemini analyses. This indicates substantial disagreement between the AI models.',
    totalDiscrepanciesExplanation: 'Number of articles where ChatGPT and Gemini provide different analyses (any difference > 0 points)',
    averageDiscrepancyExplanation: 'Average total difference points per article across all three dimensions (polarity + subjectivity + centrality)',
  ...
  arbiter: {
    ...
    blindEvaluationDesc: 'Model identities are hidden from the arbiter. It only sees "Model A" and "Model B".',
    ...
    selectionProcessDesc: 'Articles with significant disagreements (≥3 points difference on any dimension) between the two models are selected for arbitration.',
    blindAssignment: 'Blind Assignment',
    blindAssignmentDesc: 'For each model pair, one model is randomly assigned as "Model A" and the other as "Model B". This assignment is consistent across all articles in the pair to ensure unbiased evaluation.',
    ...
    geminiArbiterDesc: 'Gemini 3 Pro is used as the arbiter with high reasoning level enabled. This allows for extended thinking and more nuanced analysis when comparing model outputs.',
    evaluationScales: 'Evaluation Scales',
    viewPrompt: 'View Prompt',
    promptExplanation: 'The arbiter uses a carefully crafted system instruction and user prompt template to ensure consistent and thorough evaluation.',
    viewFullPrompt: 'View Full Prompt',
