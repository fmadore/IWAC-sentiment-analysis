...
export const fr: Translations = {
  ...
  arbiter: {
    ...
    blindEvaluationDesc: 'Les identités des modèles sont masquées. L\'arbitre ne voit que « Modèle A » et « Modèle B ».',
    ...
    selectionProcessDesc: 'Les articles présentant des désaccords significatifs (≥3 points de différence sur une dimension) entre les deux modèles sont sélectionnés pour l\'arbitrage.',
    blindAssignment: 'Attribution aveugle',
    blindAssignmentDesc: 'Pour chaque paire de modèles, un modèle est assigné aléatoirement comme « Modèle A » et l\'autre comme « Modèle B ». Cette attribution est cohérente pour tous les articles de la paire afin de garantir une évaluation impartiale.',
    evaluationProcess: 'Processus d\'évaluation',
    step1: 'L\'arbitre lit le texte complet de l\'article',
    step2: 'Il fournit ses propres scores indépendants pour la polarité, la subjectivité et la centralité',
    ...
    geminiArbiterDesc: 'Gemini 3 Pro est utilisé comme arbitre avec le niveau de raisonnement élevé activé. Cela permet une réflexion approfondie et une analyse plus nuancée lors de la comparaison des sorties des modèles.',
    evaluationScales: 'Échelles d\'évaluation',
    viewPrompt: 'Voir le prompt',
    promptExplanation: 'L\'arbitre utilise une instruction système soigneusement conçue et un modèle de prompt utilisateur pour garantir une évaluation cohérente et approfondie.',
    viewFullPrompt: 'Voir le prompt complet',
