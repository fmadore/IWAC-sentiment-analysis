...
function filterCategoryAnalysis(
  ...
  const keywordsByCountry: Record<string, { subject: Record<string, number>; spatial: Record<string, number> }> = {};
  const keywordsByNewspaper: Record<string, { subject: Record<string, number>; spatial: Record<string, number> }> = {};
